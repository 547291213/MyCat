...
public class FileItem {
    ...
    private String videoScaledDownPath ; //视频略缩图 ， 视频文件专用
    ...
    public String getVideoScaledDownPath() {
        return videoScaledDownPath;
    }
    ...
    public void setVideoScaledDownPath(String videoScaledDownPath){
        this.videoScaledDownPath = videoScaledDownPath ;
    }
}